...
public class Bobing {
    class Award {
        ...
        static final String[] name= {"状元","对堂","三红","四进","二举","一秀"};
        static public int[] top=new int[6];//记录当届状元
        static public int top_no;//当届状元编号
        static public int[] awards= {1,2,4,8,16,32};//奖项剩余数量
    ...
    public class Player
    {
        ...
        private int judge_top_rank(int[] res)//状元分级
        {
            ...
            if(res[3]==6)
                rank=5;//六红
            for(int i=0;i<6;i++)//六黑内部根据点数大小评级
                if(res[i]==6)
                {
                    rank=4;//六黑
                    sum+=i;
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("博饼结束，接下来揭示欧皇与非酋：");
